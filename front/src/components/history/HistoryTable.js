                      ...
                      findIncomeAndDelete(userID, id)
                        .then((res) => {
                          ...
                          createNewLog({
                            ...
                            userID: id,
                            action: `Vartotojas ${username} ištrynė pajamų irašą. Data: ${new Date().toLocaleString()}`,
                      ...
                      findExpensesAndDelete(userID, id)
                        .then((res) => {
                          ...
                          createNewLog({
                            ...
                            incexpCategory: category,
                            userID: id,
                            action: `Vartotojas ${username} ištrynė išlaidų įrašą. Data: ${new Date().toLocaleString()}`,
                            time: new Date().toLocaleString(),
                            sum: sum,
                            name: username,
                            email: email,
